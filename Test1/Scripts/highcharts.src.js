    ...
    Highcharts.PlotLineOrBand.prototype = {
        ...
        */
        render: function () {
            ...
            // plot line
            if (width) {
                path = axis.getPlotLinePathPartial(value, width, percentFrom, percentTo);
                attribs = {
                    stroke: color,
                    'stroke-width': width
                };
    ...
    */
    ...
    Axis.prototype = {
        ...
        */
        ...
        getPlotLinePathPartial: function (value, lineWidth, percentFrom, percentTo, old, force, translatedValue) {
            var axis = this,
            chart = axis.chart,
            axisLeft = axis.left,
            axisTop = axis.top,
            ...
            if (isNaN(translatedValue)) { // no min or max
                ...
                x1 = axisLeft + (cWidth - axis.right - axis.left) * percentFrom;
                x2 = axisLeft + (cWidth - axis.right - axis.left) * percentTo;
