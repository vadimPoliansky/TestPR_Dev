...
//                    allFootnotes = db.Footnotes.ToList()
        ...
        public ActionResult viewPRExcel(Int16 fiscalYear, Int16? coeID)
        {
            ...
            {
                var testEf = new ExcelPackage();
                var testWb = testEf.Workbook;
                var testWs = testWb.Worksheets.Add("test");
                testWs.Cells[1, 2].Style.Fill.PatternType = OfficeOpenXml.Style.ExcelFillStyle.Solid;
                testWs.Cells[1, 2].Style.Fill.BackgroundColor.SetColor(System.Drawing.Color.Red);
                testEf.SaveAs(memoryStream);
